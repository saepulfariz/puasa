...
// script by saepulfariz 08/04/2021 versi PHP
    				...
    				<div class="card-body">
    					<div class="table-responsive">
    						...
    						<table class="table text-white table-hover ">
							  ...
							  <tbody>
							    <?php foreach ($puasa as $key): ?>
							    	<tr>
							    		<td><?= $key['tanggal']; ?> Ramadan</td>
							    		<td class="bg-success"><?= $key['imsak']; ?></td>
							    		<td><?= $key['subuh']; ?></td>
							    		<td><?= $key['terbit']; ?></td>
							    		<td><?= $key['dhuha']; ?></td>
							    		<td><?= $key['dzuhur']; ?></td>
							    		<td><?= $key['ashar']; ?></td>
							    		<td class="bg-success"><?= $key['magrib']; ?></td>
							    		<td><?= $key['isya']; ?></td>
							    	</tr>
							    <?php endforeach ?>
							  </tbody>
